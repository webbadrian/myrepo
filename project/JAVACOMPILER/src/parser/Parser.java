...
public class Parser {
	...
	Stmt block ( ) throws IOException { // block - > { de c l s stmt s }
	...
	Type type () throws IOException {
		Type p = (Type )look ; // expect look. tag == Tag .BAS IC
		match(Tag .BASIC) ;
...
/			Token tok = look ; move ( ) ; x = new And ( tok , x, equality ());
	...
	Access offset ( Id a) throws IOException { // I -> [E] I [E] I
		...
		Expr i ; Expr w = null; Expr t1 , t2 ; Expr loc; // inherit id
		Type type = a . type ;
